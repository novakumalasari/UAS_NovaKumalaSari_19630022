                    ...
                    <form action="{{ route('update.mahasiswa', $mahasiswa->id)}}" method="post">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label for="">NPM</label>
                                    <input type="number" name="npm" class="form-control" place="Masukkan NPM" maxleght = "8" value="{{ is_null
                                    ($mahasiswa) ? '' : $mahasiswa->npm}}">
                                </div>
                                <div class="col">
                                    <label for="">Tempat Lahir</label>
                                    <input type="text" name="tempat_lahir" class="form-control" place="Tambahkan Tempat Lahir" value="{{ is_null
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="date" name="tgl_lahir" class="form-control" place="Tambahkan Tanggal Lahir" value="{{ is_null
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" name="telepon" class="form-control" place="Masukkan Telepon" value="{{ is_null
